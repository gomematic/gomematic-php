...
class UserApi
{
     ...
     * @param  \Gomematic\Model\UserTeamParams $userTeam The user team data to assign (required)
     *
     ...
     * Create a new user
     *
     * @param  \Gomematic\Model\User $user The user data to create (required)
     *
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gomematic\Model\User|object|object|object|object
     */
     ...
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gomematic\Model\User|object|object|object|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUserWithHttpInfo($user)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gomematic\Model\User' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gomematic\Model\User', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Gomematic\Model\User';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     *
     * @param  string $userId A user UUID or slug (required)
     * @param  \Gomematic\Model\UserTeamParams $userTeam The user team data to delete (required)
     *
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|object|object|object|object
     ...
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gomematic\Model\User[]|object|object
     */
     ...
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gomematic\Model\User[]|object|object, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $userId A user UUID or slug (required)
     * @param  \Gomematic\Model\UserTeamParams $userTeam The user team data to update (required)
     *
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|object|object|object|object
     ...
     *
     * @param  string $userId A user UUID or slug (required)
     * @param  \Gomematic\Model\User $user The user data to update (required)
     *
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gomematic\Model\User|object|object|object|object
