...
class AuthApi
{
     ...
     *
     * @param  \Gomematic\Model\InlineObject $auth auth (required)
     *
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gomematic\Model\AuthToken|object|object
     */
     ...
     * Authenticate an user by credentials
     *
     * @param  \Gomematic\Model\InlineObject $auth (required)
     *
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gomematic\Model\AuthToken|object|object, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gomematic\Model\AuthVerify|object|object
     */
     ...
     * @throws \Gomematic\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gomematic\Model\AuthVerify|object|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function verifyAuthWithHttpInfo($token)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gomematic\Model\AuthVerify' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gomematic\Model\AuthVerify', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
